...
var first_turn_used := false  # ✅ أول هجمة
...
func enemy_turn():
	...
	var attacker_stat = 4
	var defender_stat = 4
	var result = damagecap.calculate_damage(move_power, attacker_stat, defender_stat)
...
func _on_attack_pressed() -> void:
	...
	# ✅ Extra Turn مجاني لأول مرة فقط
	if not first_turn_used:
		first_turn_used = true
		print("🎁 First Free Extra Turn")
