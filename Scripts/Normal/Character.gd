...
static var CHARACTER_DETAILS : Dictionary = {
	Name.protoganist: {
		"name" : "protoganist",
		"gender" : "male",
		"animation" : preload("res://Scenes/Characters/Protoganist.tres")
	},
	
	Name.kami: {
		"name": "kami",
		"gender" : "female",
		"animation" : preload("res://Scenes/Characters/Kami.tres")
	},
	Name.fujiwara: {
		"name": "fujiwara",
		"gender" : "male",
		"animation" : preload("res://Scenes/Characters/fujiwara.tres")
	},
	Name.yatufusta: {
		"name": "yatufusta",
		"gender" : "male",
		"animation" : preload("res://Scenes/Characters/yatufusta.tres")
	},
	Name.PigEnemy: {
		"name": "PigEnemy",
		"gender" : "male",
		"animation" : preload("res://Scenes/Characters/PigEnemy.tres")
	},
	Name.BirdEnemy: {
		"name": "BirdEnemy",
		"gender" : "male",
		"animation" : preload("res://Scenes/Characters/BirdEnemy.tres")
	},
}
